    ...
    <div className='container mx-auto mt-12 max-w-6xl'>
      <div className='flex items-center justify-between max-md:flex-col max-md:items-start max-md:space-y-2'>
        ...
        <div className="flex items-center gap-2">
          ...
          <Select>
            <SelectTrigger className="w-[140px] bg-gradient-to-r from-secondary to-background">
          ...
          <Select>
            <SelectTrigger className="w-[140px] bg-gradient-to-l from-secondary to-background">
