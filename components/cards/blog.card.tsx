            ...
            <div className={'group grid grid-cols-1 gap-4'}>
                <div className='relative rounded-md bg-secondary'>
                    <Image
                        ...
                        src={blog.img.url}
                        alt={blog.title}
                        className='-translate-y-6 rounded-md object-cover px-2 grayscale transition-all group-hover:-translate-y-7 
                        group-hover:grayscale-0 max-md:-translate-y-2 max-md:group-hover:-translate-y-3 md:px-7'
                    />
                </div>
